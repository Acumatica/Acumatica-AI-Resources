# Company with Branches that Require Balancing: Implementation Checklist {#_7d2615bd-ca38-4d51-9123-af50c3309978 .concept}
...
|[Companies](../UserGuide/CS_10_15_00.md) \(CS101500\) form|Make sure that the necessary company has been created with the *With Branches Requiring Balancing* type and that the necessary ledger has been created and assigned to it.| |
