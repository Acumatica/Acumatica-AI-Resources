# Asset Migration: Implementation Checklist {#_19f9c738-238d-421a-ae91-8dd5d64e17c1 .concept}
...
## Implementation Checklist {#section_hxg_ljv_vxb .section}
...
|[Vendors](AP_30_30_00.md) \(AP303000\)|The vendor accounts for the vendors for which you will create AP bills have been defined in the system. For details, see [Vendors: Implementation Activity](Vendor_Implem_Activity.md).|

## Other Settings That Affect the Workflow {#section_jxg_ljv_vxb .section}
...
-   You clear the **Require Vendor Reference** check box in the **Data Entry Settings** section if you want to avoid entering a vendor reference number in the **Vendor Ref.** box on the [Bills and Adjustments](AP_30_10_00.md) form. If your company requires this data to be entered, you select the check box.
-   If you want AP bills to be automatically posted to the general ledger once they are entered, you make sure that the **Automatically Post on Release** check box is selected in the **Posting Settings** section. Otherwise, you should clear this check box.
...
## Validation of Configuration {#section_nxg_ljv_vxb .section}

To make sure that all configuration has been performed correctly, we recommend that in your system, you migrate fixed assets by performing instructions similar to those described in [Asset Migration: To Create a Partially Depreciated Asset](FixedAssets_Data_Migration_To_Create_Partially_Depr_Asset.md), [Asset Migration: To Migrate Fixed Assets](FixedAssets_Data_Migration_To_Migrate_Assets.md), and [Asset Migration: To Apply the Section 179 Deduction \(Optional\)](FixedAssets_Data_Migration_To_Apply_Section_179_Deduction.md).
