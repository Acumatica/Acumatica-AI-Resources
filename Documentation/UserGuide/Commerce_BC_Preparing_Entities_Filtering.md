# Preparing Entities for Synchronization: Filtering {#_88f927d5-f617-419f-8279-b614c58633b7 .concept}

In this topic, you will learn how you can define export and import filtering settings.

## Export and Import Filtering { .section}

You can configure the rules according to which data from Acumatica ERP should be exported to the online store by using the **Export Filtering** tab of the [Entities](../Shared/../UserGuide/BC_20_20_00.md) \(BC202000\) form. You define the filters for data import on the **Import Filtering** tab.
