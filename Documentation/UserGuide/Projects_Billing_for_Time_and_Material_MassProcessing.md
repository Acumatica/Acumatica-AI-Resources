# Time and Material Billing: Mass Processing {#_79fb2ff4-ee94-45fc-9f56-d4723c37086f .concept}
...
## Mass-Releasing AR Invoices { .section}

Multiple accounts receivable invoices can be released at the same time on the [Release AR Documents](../Shared/../UserGuide/AR_50_10_00.md) \(AR501000\) form. On this form, you select the unlabeled check boxes in the rows of the documents to be processed and click **Release** on the form toolbar to release the selected invoices; alternatively, you can click **Release All** to release all the invoices shown in the table.
