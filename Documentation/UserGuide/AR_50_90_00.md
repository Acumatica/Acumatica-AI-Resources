# Close Financial Periods {#_c2c5bb0b-afb1-4b9d-8828-f70ff8f07add .reference}
...
|Button|Description|
|------|-----------|
|**Process**|Initiates the process of closing or reopening the selected financial periods \(that is, those for which you have selected the unlabeled check boxes in the table\). **Attention:** The green OK icon appears in the form toolbar if the closing or reopening operation was completed successfully. The red icon indicates that the operation failed to complete successfully, because required conditions were not met or an error occurred.
...
|Element|Description|
|-------|-----------|
|**Company**|The company for which you want to close or reopen financial periods. By default, the current company is selected.
