# Mailings for Customers: To Set Up a Mailing for a Customer Class {#_c1a41172-53d9-4e60-a926-9c577120c628 .task}
...
-   On the [Customer Classes](AR_20_10_00.md) \(AR201000\) form, the *INTLCA* customer class has been created.
-   On the [Customers](AR_30_30_00.md) \(AR201000\) form, the *LAKECAFE* customer has been created and the *INTLCA* customer class has been assigned to it.

## Process Overview { .section}

In this activity, you will first review the settings on the **Mailing &amp; Printing** tab of the [Sales Orders Preferences](SO_10_10_00.md) \(SO101000\) form. On the [Customer Classes](AR_20_10_00.md) \(AR201000\) form, you will set up a mailing for customers of a particular customer class. On the [Sales Orders](SO_30_10_00.md) \(SO301000\) form, you will create and email a sales order. Finally, on the [Email Activity](CR_30_60_15.md) \(CR306016\) form, you will review the email that was automatically generated by the system based on the specified mailing settings.
...
## Step 1: Verifying the Sales Order Preferences { .section}
...
## Step 2: Setting Up a Mailing for a Customer Class { .section}
...
5.  In the **Mailings** table, specify the following settings in the row for the *SALES ORDER* mailing:
    ...
    -   **Branch**: Empty.
        ...
        **Tip:** The **Branch** column is read-only. If a branch was selected for the mailing on the [Sales Orders Preferences](SO_10_10_00.md) \(SO101000\) form, this branch is associated with the mailing for this customer class. In this case, the mailing would be set up for the specified branch.
...
5.  On the More menu, click **Email Sales Order** to send an email to the customer and to the assigned employee of SweetLife.
...
1.  While you are still on the [Sales Orders](SO_30_10_00.md) \(SO301000\) form with the order opened, click **Activities** on the form title bar.
