# Purchase Accrual Summary {#_3c65e807-b1be-4bb0-a2d4-86f95061c43d .reference}
...
The data in the report is grouped by the account and subaccount numbers used to accumulate the value of the purchased goods; subtotals are calculated for each unique account and subaccount combination.

**Attention:** The received cost and quantity are updated in the report after the release of the purchase receipt, regardless of the release of the corresponding inventory transaction and general ledger batch.
