# Upgrading a Default Component of Model Equipment to Be Sold {#_60aad243-046c-4d27-9b7b-ed7165421996 .concept}
...
![](Images/FS__Upgrading_Component.png "Selling model equipment and upgrading a default component within a service order")
...
When the invoice related to the service order is released, the system adds a record for the new target equipment entity with the *Active* status on the [Equipment](FS_20_50_00.md) \(FS205000\) form, including a new component of the *Active* status on the **Components and Warranties** tab.
