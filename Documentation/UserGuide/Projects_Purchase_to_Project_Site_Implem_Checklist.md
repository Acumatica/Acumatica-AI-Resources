# Purchases to the Project Site: Implementation Checklist {#_08a97724-8cec-403d-8f45-9d9fecf4b6b5 .concept}
...
|
|[Projects](PM_30_10_00.md) \(PM301000\)|Make sure that the necessary projects and project tasks have been created, and that the following settings have been specified for the projects on the **Defaults** tab:-   **Drop-Ship Receipt Processing**: *Skip Receipt Generation*
