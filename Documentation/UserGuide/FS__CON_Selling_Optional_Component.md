# Selling a Model Equipment Entity and Optional Component {#_9dc13be1-3401-4b36-a369-aff8ad068739 .concept}
...
![](Images/FS__Selling_Optional_Component_Model_Equipment.png "Selling model equipment and its optional component within a service order")
...
When the invoice related to the service order is released, the system automatically adds a record for the new target equipment entity with the *Active* status on the [Equipment](FS_20_50_00.md) \(FS205000\) form, including an optional component of the *Active* status on the **Components and Warranties** tab.
