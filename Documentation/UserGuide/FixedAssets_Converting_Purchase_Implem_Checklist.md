# Conversion of a Purchase: Implementation Checklist {#_c5f4b773-5e31-46a1-b95b-7c29c8978408 .concept}
...
## Implementation Checklist {#section_ymc_ljv_vxb .section}
...
|[Vendors](AP_30_30_00.md) \(AP303000\)|Vendor accounts exist for the vendors for which you will create AP bills. For details, see [Vendors: Implementation Activity](Vendor_Implem_Activity.md).|

## Other Settings That Affect the Workflow {#section_anc_ljv_vxb .section}
...
-   You clear the **Require Vendor Reference** check box in the **Data Entry Settings** section if you want users to avoid entering a vendor reference number in the **Vendor Ref.** box on the [Bills and Adjustments](AP_30_10_00.md) form. If your company requires this data to be entered, you select the check box.
...
## Validation of Configuration {#section_enc_ljv_vxb .section}

To make sure that all configuration has been performed correctly, we recommend that in your system, you convert purchases to fixed assets by performing instructions similar to those described in [Conversion of a Purchase: To Convert a Purchase to an Asset](FixedAssets_Converting_Purchase_To_Convert_to_Asset.md) and [Conversion of a Purchase: To Convert a Purchase to Multiple Assets](FixedAssets_Converting_Purchase_To_Convert_to_Multiple_Assets.md).
