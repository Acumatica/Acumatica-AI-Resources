# Replacing a Component of Target Equipment {#_d27df3d8-d475-481f-b2e5-388f02a3aa67 .concept}
...
![](Images/FS__Replacing_Component.png "Replacing a component of target equipment")
...
When the invoice related to the service order is released, the system modifies a record for the target equipment entity on the [Equipment](FS_20_50_00.md) \(FS205000\) form. That is, the system changes the status of replaced component to *Disposed* and adds a record for a new component on the **Components and Warranties** tab.
