# Deductions from Assets: Implementation Checklist {#_c48fa7f0-b256-4dad-9122-0a771ad60b5d .concept}
...
## Implementation Checklist {#section_pvd_ljv_vxb .section}
...
## Other Settings That Affect the Workflow {#section_rvd_ljv_vxb .section}
...
## Validation of Configuration {#section_vvd_ljv_vxb .section}

To make sure that all configuration has been performed correctly, we recommend that in your system, you process deductions by performing instructions similar to those described in [Deductions from Assets: Process Activity](FixedAssets_Making_Deductions_Process_Activity.md).
