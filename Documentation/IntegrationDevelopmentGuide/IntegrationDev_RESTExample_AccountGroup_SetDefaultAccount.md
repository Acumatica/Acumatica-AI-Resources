# Specify the Default Account of an Account Group {#_98c96a8d-de93-4062-aeec-b3a991af3afc .concept}

By using the REST API, you can specify the default account of an account group on the [Account Groups](../UserGuide/PM_20_10_00.md) \(PM201000\) form.
...
```
PUT /entity/Default/25.200.001/AccountGroup HTTP/1.1
...
**Parent topic:**[AccountGroup](../IntegrationDevelopmentGuide/IntegrationDev_RESTExample_AccountGroup.md)
