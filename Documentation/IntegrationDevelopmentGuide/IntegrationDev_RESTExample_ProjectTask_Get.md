# Retrieve a Project Task {#_aa71a74c-9b66-4514-a96d-8530964af759 .concept}
...
```
GET /entity/Default/25.200.001/ProjectTask?
    $filter=ProjectID%20eq%20'TESTPR3'%20and%20ProjectTaskID%20eq%20'PHASE1' 
    HTTP/1.1
