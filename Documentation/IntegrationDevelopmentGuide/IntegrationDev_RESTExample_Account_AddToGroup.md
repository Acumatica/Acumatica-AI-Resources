# Add an Account to an Account Group {#_c11c1255-8dc2-4f80-8aaf-b2cf073a9387 .concept}

By using the REST API, you can add an account to an account group on the [Account Groups](../UserGuide/PM_20_10_00.md) \(PM201000\) form. You can view the list of available accounts on the [Chart of Accounts](../UserGuide/GL_20_25_00.md) \(GL202500\) form.
...
```
PUT /entity/Default/25.200.001/Account HTTP/1.1
