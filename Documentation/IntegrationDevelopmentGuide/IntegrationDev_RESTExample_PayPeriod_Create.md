# Create a Pay Period Schedule {#_cee93670-b4be-4b21-a473-beeb180a20c9 .concept}
...
```
PUT /entity/Default/25.200.001/PayPeriod HTTP/1.1
...
**Parent topic:**[PayPeriod](../IntegrationDevelopmentGuide/IntegrationDev_RESTExample_PayPeriod.md)
