# Specify the Progress of a Project Task {#_06e096c8-c83d-4392-9a90-b83a9acfbc8e .concept}
...
5.  Implement the [Make a Project Active](IntegrationDev_RESTExample_Project_Activate.md) example as a prerequisite to the current example. In this prerequisite example, you will prepare the project task for which the progress will be specified.
...
```
PUT /entity/Default/25.200.001/ProjectBudget HTTP/1.1
...
**Parent topic:**[ProjectBudget](../IntegrationDevelopmentGuide/IntegrationDev_RESTExample_ProjectBudget.md)
