# Create an Account Group {#_d4ad7ce9-d197-404b-865a-26cd6073df1f .concept}

By using the REST API, you can create an account group on the [Account Groups](../UserGuide/PM_20_10_00.md) \(PM201000\) form.
