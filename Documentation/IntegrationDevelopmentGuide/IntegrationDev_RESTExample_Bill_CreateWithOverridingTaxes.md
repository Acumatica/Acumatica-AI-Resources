# Create a Bill with Tax Parameters Overridden {#_b5e17d52-f113-438c-a203-c5ce85f7f52f .concept}

By using the REST API, you can create bills with the tax parameters overridden on the [Bills and Adjustments](../UserGuide/AP_30_10_00.md) \(AP301000\) form.
