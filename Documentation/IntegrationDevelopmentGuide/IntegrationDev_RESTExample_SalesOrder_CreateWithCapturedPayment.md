# Create a Sales Order with a Captured Credit Card Payment {#_d5fd790b-af98-40ae-a008-a92950400305 .concept}
...
```
PUT /entity/Default/25.200.001/SalesOrder?$expand=Payments HTTP/1.1
