# selectionAction {#_b87a3199-a4ee-4a74-87f7-431c9e8168de .concept}
...
-   *Close*: The current container should be closed after the action is completed.
 ...
 If the Redirect attribute of an action object is set to *true*, the After attribute of this object defines more complex behavior for the current container. See [Redirecting to Different Screens and Containers](MOBILE_Redirects.md) for details.
