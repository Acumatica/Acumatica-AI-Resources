# Test Instance for Customization: To Deploy an Instance with Custom Maintenance Forms {#_8c8bf0da-c13b-4822-8df3-60c2b8142846 .task}
...
1.  Open the Acumatica ERP Configuration wizard, and do the following:
    ...
    2.  On the **Instance Configuration** page, do the following:
        1.  In the **Local Path to the Instance** box, select a folder that’s outside of the `C:\Program Files (x86)`, `C:\Program Files`, and `C:\Users` folders. \(We recommend that you store the website folder outside of these folders to avoid an issue with permission to work in these folders when you customize the website.\)
        2.  In the **Training Course** box, select *T220 Data Entry and Setup Forms*.
    3.  On the **Database Configuration** page, make sure the name of the database is `SmartFix_T220`.
