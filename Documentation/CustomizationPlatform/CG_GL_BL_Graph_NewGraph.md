# To Create a Custom Graph {#_2a5390d4-caa6-4e07-bbd2-879dc004ef2d .concept}
...
6.  Click **OK**.
    ...
    ![](../Shared/Images/CG_GL_Items_Code_NewGraph.png "Adding a Code item for a custom graph to the project")
